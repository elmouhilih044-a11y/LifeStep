<footer class="bg-ink relative overflow-hidden px-8 py-12">
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-10 pb-10 border-b border-white/10">
      ...
      {{-- Navigation --}}
      <div>
        <p class="text-white text-xs font-bold uppercase tracking-widest mb-4">Navigation</p>
      ...
      {{-- Propriétaires --}}
      <div>
        <p class="text-white text-xs font-bold uppercase tracking-widest mb-4">Propriétaires</p>
        <ul class="space-y-2 text-sm text-muted">
    ...
    <div class="pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-muted">
