    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-7">
      ...
      <div class="space-y-4">
        ...
        <div class="border border-border rounded-2xl p-5 bg-white shadow-card">
          ...
          <span class="inline-flex items-center text-sm font-bold px-3 py-1 rounded-full {{ $s['bg'] }} {{ $s['text'] }}">
            {{ $s['label'] }}
          </span>
        ...
        <a href="{{ route('logements.index') }}"
           class="flex items-center justify-center gap-2 w-full border border-border text-muted font-semibold text-sm
                  py-3 rounded-2xl hover:border-ink hover:text-ink transition-colors">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
